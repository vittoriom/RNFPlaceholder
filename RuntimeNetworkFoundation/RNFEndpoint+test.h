...
- (id<RNFOperation>) getAnswersWithMaxResults:(NSNumber *)maxResults completionBlock:(RNFCompletionBlockComplete)completion errorBlock:(RNFErrorBlock)errorBlock;
